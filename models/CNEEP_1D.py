...
class CNEEP(nn.Module):
    def __init__(self, opt):
        ...
        tempL = opt.input_shape[0]  # input shape is a tuple of length 1 for 1D, e.g. (Lx,)
        input_size = opt.n_channel * (2 ** (opt.n_layer - 1)) * (tempL // (2 ** (opt.n_layer - 1)))
